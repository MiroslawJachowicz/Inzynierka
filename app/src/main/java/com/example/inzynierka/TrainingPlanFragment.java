...
public class TrainingPlanFragment extends Fragment {
            ...
            Firebasedb.collection("Users")
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful() && !task.getResult().isEmpty()) {
                            ...
                            userRole = userDocument.getString("role"); // Pobierz userRole
                                            ...
                                            public void onClick(View v) {
                                                if (isConnectedToInternet(requireContext())) {
                                                    if (Objects.equals(userRole, "Trainer")) {
                                                        ...
                                                        Toast.makeText(getActivity(), "You  can't add plan exercise, because you are not trainer", Toast.LENGTH_SHORT).show();
                                                    }
                                                }else {
    ...
    private void loadExercisesfromFirebase(LinearLayout layout, final AlertDialog dialog, final String userClub) {
                ...
                public void onClick(View v) {
                    if (isConnectedToInternet(requireContext())) {
                        if (Objects.equals(userRole, "Trainer")) {
                            ...
                            Toast.makeText(getActivity(), "You  can't delete plan exercise, because you are not trainer", Toast.LENGTH_SHORT).show();
                        }
                    }else {
                        Toast.makeText(requireContext(), "No internet connection", Toast.LENGTH_SHORT).show();
                    }
